        ...
        QWidget(parent)
{
    ...
    m_button->resize(10,10);
    m_button->setGeometry(QRect(630, 470, 10, 10));
    connect(m_button,SIGNAL(clicked()),this,SLOT([](this)->{updateTimer->start();}));
...
void myGauge1::paintEvent(QPaintEvent *)
{
    ...
    drawGraph(&painter);          //用“半圆环”来挡住绘制好的的三扇形；使其仅露出边缘一点点
...
void myGauge1::mouseMoveEvent(QMouseEvent *e)
{
